 ...
 *
 */
package net.mcreator.bandbadditions;
...
@Mod("bandb_additions")
public class BandbAdditionsMod {
	public static final Logger LOGGER = LogManager.getLogger(BandbAdditionsMod.class);
	public static final String MODID = "bandb_additions";
	...
	public BandbAdditionsMod() {
		...
		BandbAdditionsModPaintings.REGISTRY.register(bus);
