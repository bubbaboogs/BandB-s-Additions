...
import net.mcreator.bandbadditions.procedures.BombProjectileProjectileHitsBlockProcedure;
...
public class BombProjectileEntity extends AbstractArrow implements ItemSupplier {
	public static final ItemStack PROJECTILE_ITEM = new ItemStack(BandbAdditionsModItems.BOMB.get());
